        ...
        column(width = 6,
          ...
          div(class = "welcome-text",
           actionButton("tab1_button1", "Decision Tree", class = "btn-header"),
            ...
            ,actionButton("tab1_button12", "View Decision Tree")
          )
        ),
        column(width = 6,
          #div(class = "welcome-image"#,
          ...
          ,actionButton("tab2_button22", "View GLM")
      ...
      fluidRow(
        column(width = 6,
          ...
          div(class = "welcome-text",
            ...
            ,actionButton("tab3_button32", "View Bayesian Network")
          )
        ),
        ...
        column(width = 6,
          ...
          div(class = "welcome-text",
            ...
            ,actionButton("tab4_button42", "View Clustering")
          )
        )
      )        
)
